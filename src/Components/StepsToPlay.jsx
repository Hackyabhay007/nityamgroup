...
const StepsToPlay = () => {
  return (
    <div
      className="bg-cover bg-center py-32 flex flex-col justify-center items-center"
      style={{
        backgroundImage: `url('https://www.jumblebook.com/assets/images/bg1.jpg')`,
      }}
    >
      <div className="w-full px-16 flex  items-center  ">
        <p className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#dcc87e] ">
          EASY STEPS TO PLAY
        </p>
      </div>
      ...
      <div className="w-full px-10 flex flex-col space-y-4">
        ...
        <div className="flex flex-col  justify-end w-full  md:flex-row">
          <div className="text-4xl text-[#ee2946]  rounded-tl-full rounded-bl-md  bg-black  flex items-end p-4 font-bold">
            <span>Step 1</span>
          </div>
          <div className="bg-[#e22239] rounded-r-3xl text-white w-full md:w-1/2 flex justify-between items-center p-4 md:p-6">
            <div>
              <img
        ...
        {/* Step 3 */}
        <div className="flex flex-col  justify-end w-full md:flex-row">
          <div className="text-3xl text-[#018e30] rounded-tl-full rounded-b-xl  bg-black  flex items-end p-4 font-bold">
            <span>Step 3</span>
          </div>
          <div className="bg-[#018e30] rounded-r-3xl text-white w-full md:w-1/2 flex justify-between items-center p-4 md:p-6">
            <div>
              <img
        ...
        {/* Step 5 */}
        <div className="flex flex-col justify-end w-full md:flex-row">
          <div className="text-3xl text-[#e02037] rounded-tl-full rounded-b-xl  bg-black  flex items-end p-4 font-bold">
            <span>Step 5</span>
          </div>
          <div className="bg-[#e02037] rounded-r-3xl text-white w-full md:w-1/2 flex justify-between items-center p-4 md:p-6">
            <div>
              <img
                src="https://cdn3.iconfinder.com/data/icons/social-line-filled/512/whatsapp__icons__logo__social__media-512.png"
                alt=""
